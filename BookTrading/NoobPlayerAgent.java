...
public class NoobPlayerAgent extends Agent{
    ...
    class NoobBehaviour extends  SimpleBehaviour{
        @Override public void action(){
            System.out.println("Noob is ready to take turn");
            ACLMessage msg= blockingReceive();
            System.out.println("Noob received msg");
            if(msg!=null)
            {
